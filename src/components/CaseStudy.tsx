...
const CaseStudy = () => {
  ...
  const getDisplayImage = (studyId: string): string => {
    ...
    const fallbackImages: Record<string, string> = {
      'trillerfest': '/img/919bfa95-912a-489f-a859-7a42e0d7d435.png',
      'damon-motorcycles': '/img/7269bbbd-37f4-4f9e-af2b-4e6a47122f10.png',
      'unikoin-gold': '/img/unikoin-header.jpg',
      'casper-blockchain': '/images/casper/casper-1.jpg',
      'bellabeat': '/img/7269bbbd-37f4-4f9e-af2b-4e6a47122f10.png',
