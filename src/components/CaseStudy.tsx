      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {featuredStudies.slice(0, 4).map((study, index) => (
            <div
              key={study.id}
              className="relative aspect-[4/3] overflow-hidden group reveal rounded-xl shadow-lg"
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-6">
                ...
                <p className="text-white/80 mt-1 text-sm font-medium">{study.subtitle}</p>
        ...
        <div className="mt-12 text-center md:text-left">
          <Link to="/our-work" className="lets-talk-btn">
