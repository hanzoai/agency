...
const Navbar = () => {
  ...
  return <header className={`fixed left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-black/95 backdrop-blur-sm' : 'bg-transparent'}`} style={{
      ...
      <div className="container-custom">
        <div className="flex items-center justify-between py-4">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <Link to="/#faq" className="text-primary/80 hover:text-primary font-medium transition py-[32px]">FAQ</Link>
          </nav>
