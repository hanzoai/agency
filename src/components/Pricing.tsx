    ...
    <section id="pricing" className="section-padding bg-beige-50">
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-white/80 max-w-2xl mx-auto reveal mb-2">
            Choose the plan that fits your needs. All plans include our widely acclaimed team of design experts.
          </p>
          <p className="text-md text-accent/90 font-medium max-w-2xl mx-auto reveal flex items-center justify-center gap-1">
            <Info size={18} />
        ...
        <div className="grid md:grid-cols-3 gap-8 reveal-slide-up">
          {/* Starter Plan */}
          <Card className="border border-black/10 overflow-hidden flex flex-col h-full bg-[#282828] rounded-2xl">
            <CardHeader className="bg-black p-8 text-white text-center rounded-t-2xl">
            ...
            <CardFooter className="p-6 pt-0">
              <Link to="/subscribe" className="lets-talk-btn w-full justify-center text-lg py-3 rounded-xl">
                Start free trial
          ...
          {/* Growth Plan */}
          <Card className="border-2 border-accent overflow-hidden flex flex-col h-full shadow-lg relative bg-[#282828] rounded-2xl">
            <div className="absolute top-0 right-0 bg-accent text-white px-4 py-1 text-sm font-bold rounded-bl-xl">
              POPULAR
            </div>
            <CardHeader className="bg-accent p-8 text-white text-center rounded-t-2xl">
            ...
            <CardFooter className="p-6 pt-0">
              <Link to="/subscribe" className="lets-talk-btn w-full justify-center text-lg py-3 bg-accent hover:bg-accent/90 rounded-xl">
                Start free trial
                <ArrowUpRight size={20} className="ml-2" />
              </Link>
            </CardFooter>
          ...
          <Card className="border border-black/10 overflow-hidden flex flex-col h-full bg-[#282828] rounded-2xl">
            ...
            <CardFooter className="p-6 pt-0">
              <Link to="/contact" className="lets-talk-btn w-full justify-center text-lg py-3 bg-primary/10 text-primary hover:bg-primary/20 rounded-xl">
                Talk to Sales
                <ArrowUpRight size={20} className="ml-2" />
              </Link>
            </CardFooter>
        ...
        <div className="mt-12 text-center">
          ...
          <Link to="/contact" className="lets-talk-btn rounded-xl">
            Contact us
