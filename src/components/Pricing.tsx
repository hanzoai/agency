...
const features = ["Unlimited Project Requests Every Month", "Quick Response & Delivery", "No contracts. Cancel Anytime.", "One Rate For All Your Funnel Building Needs", "All the skills you need to start, grow, and scale your online business", "Professional graphic designers & funnel building experts"];
const Pricing = () => {
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 reveal-slide-up">
            <div className="bg-white overflow-hidden border border-black/10">
              ...
              <div className="p-8">
                ...
                <a href="/subscribe" className="lets-talk-btn w-full justify-center text-lg py-3">
                  Let's talk
          ...
          <div className="order-1 md:order-2 reveal-slide-right">
            ...
            <div className="bg-white p-6 border border-black/10 mb-6">
              <h3 className="font-bold mb-2 uppercase">For Teams of All Sizes</h3>
            ...
            <div className="bg-accent/10 p-6 border border-accent/20">
              <div className="flex items-center mb-2">
                <span className="font-bold bg-accent text-white px-3 py-1 text-sm mr-3">$650 OFF</span>
