...
const TrillerFestGallery = () => {
  ...
  const images = [
    {
      src: '/img/6f11fa66-23b1-4967-aab8-1fa841066ef6.png',
      alt: 'TrillerFest marshmello promo'
    },
    {
      src: '/img/6d99dc8e-9c12-43be-92a0-2ccfff19df71.png',
      alt: 'TrillerFest event poster'
    },
    {
      src: '/img/6b15d7d1-402e-4fe9-b788-242699e6177b.png',
      alt: 'TrillerFest Migos announcement'
    },
    {
      src: '/img/ea67c751-6546-4b12-8db7-f9089164b222.png',
      alt: 'TrillerFest Pitbull announcement'
    },
    {
      src: '/img/9192c050-a4bd-4523-946f-5e21a2628214.png',
