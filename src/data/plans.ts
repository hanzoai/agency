...
export const plans: Plan[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    persona: 'creative',
    avatar: '/agents/creative.png',
    badge: 'BENCHMARK LEADER · $41K MARGIN',
    ...
    benchmark: {
      metric: 'Margin Booked (12 Wks)',
      value: '$41,407',
      multiple: '1.9× control',
      detail: '7.6 deals closed, $6,035 avg deal value, 17% reply rate, 89% delivered to scope',
    },
  ...
  },
  {
    ...
    benchmark: {
      ...
      value: '3,820',
      multiple: '3.6× control',
      detail: '159,950 views / account, 94% scheduled post completion, $0.15 cost per 1k views',
    },
  ...
  },
  {
    ...
    benchmark: {
      metric: 'Median Views / Clip',
      value: '5,240',
      multiple: '2.9× control',
      detail: '67% hold rate at 3 seconds, 7.8 viral clips per source hour mined',
    },
  ...
  },
  {
    ...
    benchmark: {
      ...
      value: '31 / 60 terms',
      multiple: '2.4× control',
      detail: '34% AI answer engine citation share, 82 indexed pages shipped, DR 0-4 baseline',
    },
  ...
  },
  {
    ...
    estimatedRevenue: '3.2× – 5.5× Blended ROAS improvement',
    features: [
