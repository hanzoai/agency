        ...
        <main className="flex-grow pt-24">
          <div className="container-custom">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-16 reveal">
              <img alt="Damon Motorcycles Campaign" className="w-full h-auto aspect-square object-cover rounded-lg" src="/img/f1c3cbd8-053c-47d1-a5ae-db2661fea19c.jpg" />
              <img src="/img/050894ef-9663-4050-b4f3-703025fef28a.png" alt="Damon Motorcycles Result" className="w-full h-auto aspect-square object-cover rounded-lg" />
            </div>
