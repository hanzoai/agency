        ...
        <main className="flex-grow pt-24">
          <div className="container-custom">
            ...
            <div className="mb-16 reveal">
              <img src="/img/7269bbbd-37f4-4f9e-af2b-4e6a47122f10.png" alt="Damon Motorcycles" className="w-full h-auto aspect-video object-cover rounded-lg" />
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-16 reveal">
              <img src="/img/a3b71b20-25c9-4e99-bf92-77d0c847b5e9.png" alt="Damon Motorcycles Campaign" className="w-full h-auto aspect-square object-cover rounded-lg" />
              <img src="/img/3e0ed6d6-8d6d-4b77-a6c1-aa1c7df4f868.png" alt="Damon Motorcycles Result" className="w-full h-auto aspect-square object-cover rounded-lg" />
            </div>
            ...
            <div className="mb-16 reveal">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="relative aspect-[4/3] overflow-hidden group">
                  <img src="/img/919bfa95-912a-489f-a859-7a42e0d7d435.png" alt="TrillerFest Music Festival" className="w-full h-full object-cover" />
