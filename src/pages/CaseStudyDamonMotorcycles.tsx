        ...
        <main className="flex-grow pt-24">
          <div className="container-custom">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-16 reveal">
              <img src="/lovable-uploads/be05da79-076e-41dd-87e9-ca6f8277c082.png" alt="Damon Motorcycles Campaign" className="w-full h-auto aspect-square object-cover rounded-lg" />
