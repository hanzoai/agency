  ...
  useEffect(() => {
    ...
    const projectsData: Record<string, Project> = {
      ...
      'casper-blockchain': {
        ...
        challenge: 'The blockchain sector confronted major hurdles to enterprise adoption, such as performance constraints, security vulnerabilities, and insufficient enterprise-level functionality. Casper Labs required strategic direction and technical proficiency to build a solution capable of meeting intricate commercial requirements.',
