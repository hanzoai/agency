    ...
    const projectsData: Record<string, Project> = {
      'triller': {
        ...
        technologies: ['React', 'WebRTC', 'Node.js', 'AWS Media Services', 'WebGL'],
            galleryImages: [
              '/img/919bfa95-912a-489f-a859-7a42e0d7d435.png', // TrillerFest logo on red bg
              '/img/050894ef-9663-4050-b4f3-703025fef28a.png', // Image 2
              '/img/3e0ed6d6-8d6d-4b77-a6c1-aa1c7df4f868.png', // Image 3
              '/img/7269bbbd-37f4-4f9e-af2b-4e6a47122f10.png'  // Damon motorcycles image
            ]
      },
      'damon': {
        id: 'damon',
