    ...
    const projectsData: Record<string, Project> = {
      'triller': {
        ...
        technologies: ['React', 'WebRTC', 'Node.js', 'AWS Media Services', 'WebGL'],
            galleryImages: [
              '/img/919bfa95-912a-489f-a859-7a42e0d7d435.png',  // Main poster (Image 1) 
              '/img/3e0ed6d6-8d6d-4b77-a6c1-aa1c7df4f868.png',  // Migos image (Image 2)
              '/img/7269bbbd-37f4-4f9e-af2b-4e6a47122f10.png'   // Pitbull image (Image 3)
            ]
      },
      'damon': {
        id: 'damon',
